        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">Med Labs</h2>
                    <p> Lab Services - Innovating Healthcare</p>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="departments.php"><span class="icon-long-arrow-right mr-2"></span>Departments</a></li>
                        <li><a href="doctors.php"><span class="icon-long-arrow-right mr-2"></span>Doctors</a></li>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">101 Colombo 5, Sri Lanka</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">+011 222 3333</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope pr-4"></span><span class="text">info@medlabs.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    ...
                    </script> All rights reserved | HealthCrew
